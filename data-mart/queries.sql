...
GROUP BY
  fact.key,
  month.key -- c. Dice, where one creates a sub‐cube. – 2 queries
  -- For instance, contrast (i) the prevalence of health conditions, (ii) the literacy
  ...
  -- a. Iceberg queries. For instance, i) find the five years with the highest
  -- population growths, ii) find the five countries with the highest decreases
